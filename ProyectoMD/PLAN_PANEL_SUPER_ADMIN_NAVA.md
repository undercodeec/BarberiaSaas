# Plan de construcción — Nava Super Admin

> Documento funcional del trabajo sobre el panel administrativo interno de
> Nava. El despliegue y la operación del panel se documentan exclusivamente en
> [`DESPLIEGUE_PANEL_ADMIN.md`](./DESPLIEGUE_PANEL_ADMIN.md).
>
