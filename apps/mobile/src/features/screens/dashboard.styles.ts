...
export const styles = StyleSheet.create({
  ...
  businessCategoryPrompt: {
    alignItems: 'flex-start',
    backgroundColor: '#FFF9EE',
    borderColor: 'rgba(199, 149, 50, 0.32)',
    borderRadius: 22,
    borderWidth: 1,
    flexDirection: 'row',
    gap: 11,
  ...
  businessCategoryPromptButtonLabel: {
    color: '#FFFFFF',
    fontSize: 13,
    fontWeight: '900',
  },
  businessCategoryPromptCopy: { flex: 1, minWidth: 0 },
  businessCategoryPromptDismiss: {
    alignItems: 'center',
    height: 28,
    justifyContent: 'center',
    marginRight: -5,
  ...
  businessCategoryPromptIcon: {
    alignItems: 'center',
    backgroundColor: 'rgba(199, 149, 50, 0.15)',
    borderRadius: 15,
    height: 38,
    justifyContent: 'center',
    width: 38,
  },
  businessCategoryPromptText: {
    color: appTheme.colors.textMuted,
    fontSize: 13,
    lineHeight: 18,
    marginTop: 3,
  },
  businessCategoryPromptTitle: {
