...
export const styles = StyleSheet.create({
  ...
  chartBars: { alignItems: 'flex-end', flexDirection: 'row', gap: 7 },
  chartCard: {
    backgroundColor: appTheme.colors.surface,
    borderRadius: 16,
    gap: 12,
  ...
  chartColumn: { alignItems: 'center', flex: 1, gap: 4 },
  chartHeader: { gap: 10 },
  chartLabel: {
    color: appTheme.colors.textMuted,
    fontSize: 10,
  ...
  chartToggleOptionActive: { backgroundColor: appTheme.colors.accentWash },
  chartToggleText: {
    color: appTheme.colors.textMuted,
    fontSize: 11,
    fontWeight: '800',
  ...
  quickDateFilters: { flexDirection: 'row', gap: 8 },
  dateChip: {
    backgroundColor: appTheme.colors.surfaceMuted,
    borderRadius: 12,
    paddingHorizontal: 11,
