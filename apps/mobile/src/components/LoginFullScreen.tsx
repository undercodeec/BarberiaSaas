...
import { ImageBackground, KeyboardAvoidingView, Platform, Pressable, ScrollView, StyleSheet, Text, TextInput, useWindowDimensions, View } from 'react-native';
    ...
    <SafeAreaView edges={['bottom', 'left', 'right', 'top']} style={styles.safeArea}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.keyboard}>
        <ScrollView contentContainerStyle={[styles.content, { minHeight: height }]} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.brand, compact ? styles.brandCompact : null]}><Text style={styles.brandName}>NAVA</Text><Text style={styles.brandMessage}>Bienvenido de nuevo</Text></View>
          <View style={styles.formCard}>
            ...
            <Link href="/(auth)/recover" style={styles.forgot}>¿Olvidaste tu contraseña?</Link>
