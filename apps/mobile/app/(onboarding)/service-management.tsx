...
import type { ServicesResponse } from '@barber-saas/api-client';
...
export default function ServiceManagementScreen() {
  ...
  const serviceMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      setPrice('');
      setSuccessMessage('Servicio creado y habilitado correctamente.');
      await queryClient.invalidateQueries({ queryKey: ['services'] });
    },
  });
  ...
  const requestError = categoryMutation.error ?? serviceMutation.error;
